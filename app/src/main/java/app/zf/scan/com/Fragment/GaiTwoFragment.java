...
public class GaiTwoFragment extends BaseFragment implements XListView.IXListViewListener {
    @InjectView(R.id.xlistview_gaitwo)
    XListView xlistviewGaitwo;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_gai_two, container, false);
        ButterKnife.inject(this, view);
        xlistviewGaitwo.setPullRefreshEnable(true);
        xlistviewGaitwo.setPullLoadEnable(true);
        xlistviewGaitwo.setXListViewListener(this);
