...
public class GaiFourFragment extends BaseFragment implements XListView.IXListViewListener {
    @InjectView(R.id.xlistview_gaifour)
    XListView xlistviewGaifour;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_gai_four, container, false);
        ButterKnife.inject(this, view);
        xlistviewGaifour.setPullRefreshEnable(true);
        xlistviewGaifour.setPullLoadEnable(true);
        xlistviewGaifour.setXListViewListener(this);
