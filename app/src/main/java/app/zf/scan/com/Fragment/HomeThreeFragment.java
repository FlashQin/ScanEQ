...
public class HomeThreeFragment extends BaseFragment implements XListView.IXListViewListener {
    ...
    @InjectView(R.id.xlistview_homethre)
    XListView xlistviewHomethre;
                ...
                try {
                    ...
                    if (c.equals("0")) {
                        ...
                        if (mapdata.size() > 0) {
                            ...
                            xlistviewHomethre.setAdapter(adapter);
                            xlistviewHomethre.stopLoadMore();
                            xlistviewHomethre.stopRefresh();
                            if (PageIndexAdd>=recommond){
                                xlistviewHomethre.setLoadALL(recommond);
                            }
                        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        xlistviewHomethre.setPullRefreshEnable(true);
        xlistviewHomethre.setPullLoadEnable(true);
        xlistviewHomethre.setXListViewListener(this);
