...
public class HomeFourFragment extends BaseFragment implements XListView.IXListViewListener {
    ...
    @InjectView(R.id.xlistview_homefour)
    XListView xlistviewHomefour;
                ...
                try {
                    ...
                    if (c.equals("0")) {
                        ...
                        if (mapdata.size() > 0) {
                            ...
                            xlistviewHomefour.setAdapter(adapter);
                            xlistviewHomefour.stopLoadMore();
                            xlistviewHomefour.stopRefresh();
                            if (PageIndexAdd>=recommond){
                                xlistviewHomefour.setLoadALL(recommond);
                            }
                        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        xlistviewHomefour.setPullRefreshEnable(true);
        xlistviewHomefour.setPullLoadEnable(true);
        xlistviewHomefour.setXListViewListener(this);
